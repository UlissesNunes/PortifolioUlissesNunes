...
export default function HeadingUn() {
  return (
    <header className='fixed top-0 left-0 z-0 w-full md:h-24 px-4 sm:px-6 py-3 sm:py-4 bg-gradient-to-r from-red-900 to-black shadow-lg flex items-center justify-between'>
      <div className='flex items-center gap-3 sm:gap-4'>
        <img src="/marcaPessoal.png" alt="Logo" className='w-8 h-8 sm:w-10 sm:h-10' />
